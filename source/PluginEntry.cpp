/**
    ...
    `CFFGLPluginInfo` that Ccu.cpp registers at static-initialisation time.
    ...
    binary: which build it is.
        ...
        strings CCU.bundle/Contents/MacOS/CCU | grep ccu
*/

extern "C" const char* CcuBuildStamp()
{
	return "ccu " CCU_VERSION " built " __DATE__ " " __TIME__;
}
