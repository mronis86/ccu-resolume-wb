/*
 * Stoatworks Labs - About window data for CCU.
 *
...
{
    inline constexpr auto name = "CCU";
    inline constexpr auto slug = "ccu";
    inline constexpr auto hook = "A camera's processing chain, for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/ccu/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/ccu/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/ccu";
